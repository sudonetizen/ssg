...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_extract_links(self):
        matches = extract_markdown_links(
            "This is text with an [imgur](https://i.imgur.com)"
        )
        self.assertListEqual([("imgur", "https://i.imgur.com")], matches)
    ...
    def test_split_one_link(self):
        ...
        self.assertListEqual([TextNode("image", TextType.LINK, "https://www.example.com/IMAGE.PNG")], new_nodes)
